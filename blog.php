...
<head>
    ...
    <meta name="description" content="Estás buscando información de temas importantes, blog JOSPROX es un buen lugar para poder informarte."/>
...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="grid-cuerpo">
            ...
            <?php include "fx-includes/contenido/blog.php"; ?>
