...
if (isset($_POST["ingresar"])) {
    ...
    $sql = "SELECT id_user FROM usuarios WHERE usuario = '$usuario' and password = '$password_encriptada'";
...
/*if (isset($_POST["registrar"])) {
	...
	$password = mysqli_real_escape_string($conexion,$_POST['pass']);
	$password_encriptada = sha1($password);
	$sqluser = "SELECT id_user FROM usuarios 
	...
	if ($filas > 0) {
		...
		//Insertar info
		$sqlusuario = "INSERT INTO usuarios (Nombre, Correo, usuario, Password, Img) 
		VALUES ('$nombre', '$correo', '$usuario', '$password_encriptada', 'main.webp')";
